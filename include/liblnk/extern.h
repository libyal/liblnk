...
#if !defined( _LIBLNK_EXTERN_H )
#define _LIBLNK_EXTERN_H

/* To export functions from the liblnk DLL define LIBLNK_DLL_EXPORT
 * To import functions from the liblnk DLL define LIBLNK_DLL_IMPORT

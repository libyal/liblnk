...
enum LIBLNK_ARGUMENT_ERROR
{
	 ...
	 */
	LIBLNK_ARGUMENT_ERROR_VALUE_OUT_OF_RANGE     = 7,
...
enum LIBLNK_COMPRESSION_ERROR
{
	 ...
	 */
	LIBLNK_COMPRESSION_ERROR_UNCOMPRESS_FAILED   = 2
};
...
enum LIBLNK_INPUT_ERROR
{
	 ...
	 */
	LIBLNK_INPUT_ERROR_MISSING_LAST_SEGMENT_FILE = 5,

	/* The last section is missing from the input
	 */
	LIBLNK_INPUT_ERROR_MISSING_LAST_SECTION      = 6
};
...
enum LIBLNK_RUNTIME_ERROR
{
	 ...
	 */
	LIBLNK_RUNTIME_ERROR_VALUE_OUT_OF_RANGE      = 12,

...
#if !defined( _LNKTOOLS_GETOPT_H )
#define _LNKTOOLS_GETOPT_H
...
typedef struct lnktools_option lnktools_option_t;

struct lnktools_option
{
...
#define lnktools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t lnktools_getopt(
                  int argument_count,
...
void lnktools_getopt_wrapped_fprint(
      FILE *stream,
...
void lnktools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const lnktools_option_t *options,
      int number_of_options );

int lnktools_getopt_get_options_string(
     const lnktools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _LNKTOOLS_GETOPT_H ) */

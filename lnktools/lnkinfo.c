...
#endif
{
	...
	int number_of_options               = (int) ( sizeof( options ) / sizeof( lnktools_option_t ) );
	int verbose                         = 0;
	...
	if( lnktools_getopt_get_options_string(
	     options,
	     number_of_options,
	     options_string,
	     32 ) != 1 )

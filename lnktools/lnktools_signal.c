...
void (*lnktools_signal_signal_handler)( lnktools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( lnktools_signal_signal_handler != NULL )
			{
				lnktools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "lnktools_signal_attach";
...
#if defined( _MSC_VER )
	lnktools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	lnktools_signal_signal_handler = NULL;

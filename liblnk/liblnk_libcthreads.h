...
#if !defined( _LIBLNK_LIBCTHREADS_H )
#define _LIBLNK_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBLNK )
#define HAVE_LIBLNK_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBLNK_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBLNK_LIBCTHREADS_H ) */
